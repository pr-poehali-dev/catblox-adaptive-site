    ...
    <section className="py-16 px-4 bg-gray-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12">
          <button className="px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold text-lg rounded-lg shadow-lg transform hover:scale-105 transition-all duration-200">
            View All Games 🐱
          </button>
        </div>
      </div>
